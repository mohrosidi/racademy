...
fviz_cluster(k2, data = dfnorm, ggtheme=theme_classic())
```
...
ggplot(data.frame(k.values, wss_values),aes(k.values, wss_values))+
...
fviz_cluster(final, geom = "point", data = dfnorm,ggtheme=theme_classic())+ ggtitle("k = 4")
```
