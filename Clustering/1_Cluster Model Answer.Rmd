...
```{r}
#Melihat 5 data teratas pada dataset yang telah dinormalisasi
head(dfnorm, 10)
```
...
```{r}
#Membuat Model K-Means Klustering dengan Jumlah K =2, nstart = 25, dengan nama K2
